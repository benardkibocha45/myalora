 ...
 * ------------------------------------------------------------------- */
   // Set the launch date
    ...
    const interval = setInterval(function () {
        ...
        // Cap days at 5 if there are more than 5 days remaining
        const displayDays = days > 5 ? 5 : days;

        // Display the result
        document.querySelector(".time.days").innerHTML = `${displayDays} <span>Days</span>`;
